        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Booking>(entity =>
            {
                entity.HasKey(e => e.BookId)
                    .HasName("PK__booking__490D1AE1E52332B9");
                ...
                entity.HasOne(d => d.IdNavigation)
                    ...
                    .HasConstraintName("FK__booking__Id__76969D2E");
            });

            modelBuilder.Entity<Pass>(entity =>
            {
                entity.HasKey(e => e.PassId)
                    .HasName("PK__pass__EFA330E7D285EAB7");
                ...
                entity.HasOne(d => d.IdNavigation)
                    .WithMany(p => p.Passes)
                    .HasForeignKey(d => d.Id)
                    .HasConstraintName("FK__pass__Id__72C60C4A");

                entity.HasOne(d => d.Vech)
                    .WithMany(p => p.Passes)
                    .HasForeignKey(d => d.Vechid)
                    .HasConstraintName("FK__pass__vechid__73BA3083");
            });

            modelBuilder.Entity<Payment>(entity =>
            {
                entity.HasKey(e => e.Payid)
                    .HasName("PK__payment__082D8EEB124B1F1C");
                ...
                entity.HasOne(d => d.Book)
                    ...
                    .HasConstraintName("FK__payment__book_id__7A672E12");

                entity.HasOne(d => d.IdNavigation)
                    .WithMany(p => p.Payments)
                    .HasForeignKey(d => d.Id)
                    .HasConstraintName("FK__payment__Id__797309D9");

                entity.HasOne(d => d.Pass)
                    .WithMany(p => p.Payments)
                    .HasForeignKey(d => d.PassId)
                    .HasConstraintName("FK__payment__pass_id__7B5B524B");
            });

            modelBuilder.Entity<Vehicle>(entity =>
            {
                entity.HasKey(e => e.Vechid)
                    .HasName("PK__vehicle__CC39EE1CF3EEEC26");
                ...
                entity.HasOne(d => d.IdNavigation)
                    ...
                    .HasForeignKey(d => d.Id)
                    .HasConstraintName("FK__vehicle__Id__6FE99F9F");
            });
